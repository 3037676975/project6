...
for x in [('ai-logo-chatgpt.png','ChatGPT','rings',(16,163,127,255)),('ai-logo-claude.png','Claude','burst',(218,103,74,255)),('ai-logo-gemini.png','Gemini','diamond',(80,105,255,255)),('ai-logo-deepseek.png','DeepSeek','wave',(29,99,237,255)),('ai-logo-qwen.png','Qwen','q',(99,70,255,255)),('ai-logo-kimi.png','Kimi','k',(20,20,24,255)),('ai-logo-copilot.png','Copilot','loop',(68,97,242,255)),('ai-logo-mistral.png','Mistral','blocks',(255,126,27,255))]: brand(*x)
for x in [('ai-tool-rag.png','RAG','R'),('ai-tool-agent.png','Agent','A'),('ai-tool-mcp.png','MCP','M'),('ai-tool-vector-db.png','Vector DB','V'),('ai-tool-prompt.png','Prompt','P'),('ai-tool-embedding.png','Embedding','E'),('ai-tool-langchain.png','LangChain','LC'),('ai-tool-langgraph.png','LangGraph','LG')]: tool(*x)
print('generated',len(list(OUT.glob('*.png'))),'PNGs')
