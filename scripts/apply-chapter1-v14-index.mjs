...
if(!html.includes('chapter1-v14-polish.css?v=14')) html=html.replace('</head>','<link rel="stylesheet" href="./chapter1-v14-polish.css?v=14">\n</head>');
if(!html.includes('chapter1-v14-generated-art.css?v=14')) html=html.replace('</head>','<link rel="stylesheet" href="./chapter1-v14-generated-art.css?v=14">\n</head>');
