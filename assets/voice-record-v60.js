(() => {
  ...
  channel.addEventListener('message',e=>{
    const m=e.data||{};
    if(m.type==='audio-unlocked'&&m.ok){unlock.textContent='✓ 声音已解锁';unlock.style.color='#68e6c8';}
    if(m.type==='state'&&m.audioUnlocked){unlock.textContent='✓ 声音已解锁';unlock.style.color='#68e6c8';}
  });
